         ...
         : Control, IMessageFilter
    {
           ...
           get { return Theme.Style; }
            set
            {
               ...
               Theme.Style = value;
                ...
                {
                    _tabsPadding = new Padding(10, 3, 7, 2);
                    _orbsPadding = new Padding(17, 4, 15, 4);
                    _tabsMargin = new Padding(6, 24 + 2, 20, 0);
                ...
                else if (value == RibbonOrbStyle.Office_2013)
                {
                    ...
                    _tabsMargin = new Padding(5, 24 + 2, 20, 0);
                    _tabContentMargin = new Padding(0, 0, 0, 2);
                    _tabContentPadding = new Padding(0);
                    _tabSpacing = 4;
                    _panelSpacing = 0;
       ...
       public bool UseAlwaysStandardTheme
        ...
        private void UpdateRegionsTabsConsiderRTL(Graphics g)
        {
           ...
           int curXPos;
           curXPos = RightToLeft == RightToLeft.No ? TabsMargin.Left + OrbBounds.Width: OrbBounds.Left - TabsMargin.Left + 4;
           ...
           foreach (RibbonTab tab in Tabs)
           {
              if (tab.Visible || IsDesignMode())
              {
                 ...
                 {
                    curXPos -= (tabSize.Width + TabsPadding.Right + TabsPadding.Left);
                 }
                 int tabTop = tab.Invisible == false || OrbVisible == true
                    ? TabsMargin.Top
                    : TabsMargin.Top - tabSize.Height - 8 + (OrbStyle == RibbonOrbStyle.Office_2013 ? 2 : 0);
                 Rectangle bounds = new Rectangle(curXPos, tabTop,
                 ...
                 if (RightToLeft == RightToLeft.No)
                 {
                    curXPos = bounds.Right + TabSpacing;
                 }
           ...
           while ((RightToLeft == RightToLeft.No ? curXPos > ClientRectangle.Right : curXPos < ClientRectangle.Left)
              && maxWidth > 0)
           {

              curXPos = TabsMargin.Left + OrbBounds.Width;
              maxWidth--;
              ...
              foreach (RibbonTab tab in Tabs)
              {
                 if (tab.Visible)
                 {
                    ...
                    {
                       tab.SetTabBounds(new Rectangle(curXPos, TabsMargin.Top,
                            maxWidth, tab.TabBounds.Height));
                    }
                    else
                    {
                       tab.SetTabBounds(new Rectangle(
                            new Point(curXPos, TabsMargin.Top),
                            tab.TabBounds.Size));
                    }

                    curXPos = tab.TabBounds.Right + TabSpacing;
                 }
              }
           }
